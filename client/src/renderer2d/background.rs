...
use crate::renderer::{
    derive_vertex, include_shader, DefaultRender, Framebuffer, Layer, MeshBuilder, RenderLayer,
    Renderer, Shader, ShaderBinding, TriangleBuffer,
};
use kodiak_common::glam::{uvec2, vec2, IVec2, UVec2, Vec2};
use std::ops::Range;
...
impl DefaultRender for FrameCache {
    fn new(renderer: &Renderer) -> Self {
        ...
        let shader = include_shader!(renderer, "framebuffer");
