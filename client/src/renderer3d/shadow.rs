...
use super::Camera3d;
use crate::renderer::{Framebuffer, Layer, RenderLayer, Renderer, ShaderBinding, Texture};
use kodiak_common::glam::{Mat4, UVec2, Vec3};
use std::ops::Deref;
...
pub struct ShadowLayer<L> {
    ...
    /// The [`Layer`] passed to [`with_viewport`][`Self::with_viewport`].
    #[layer]
    pub inner: L,
}
