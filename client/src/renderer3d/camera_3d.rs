...
use crate::renderer::{Renderer, ShaderBinding};
use kodiak_common::glam::{Mat4, Vec3};
...
impl Camera3d {
    ...
    fn debug_assert_valid(&self) {
        ...
        if self.vp_matrix == Mat4::default() {
            crate::js_hooks::console_log!("using invalid Camera3d")
        }
    }
}
...
impl Camera3d {
    ...
    pub fn world_to_ndc(&self, pos: Vec3) -> Vec3 {
