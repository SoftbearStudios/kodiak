...
use kodiak_common::glam::{Vec2, Vec2Swizzles, Vec3, Vec4};
...
fn convert(v: u8) -> f32 {
    ...
    fast_srgb8::srgb8_to_f32(v)
}

/// Converts a red, green or blue f32 to a u8.
pub fn unconvert(v: f32) -> u8 {
    #[cfg(not(feature = "renderer_srgb"))]
    return (v * u8::MAX as f32) as u8;
    #[cfg(feature = "renderer_srgb")]
    fast_srgb8::f32_to_srgb8(v)
}
