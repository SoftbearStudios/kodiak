...
use kodiak_common::glam::{UVec2, Vec4};
use std::rc::Rc;
...
impl Framebuffer {
    ...
    fn new_inner(
        ...
        let depth_stencil = depth_stencil.then(|| {
            if depth_texture {
                #[cfg(not(feature = "renderer_depth_texture"))]
                unreachable!();
                #[cfg(feature = "renderer_depth_texture")]
        ...
        debug_assert!(
            cfg!(feature = "renderer_srgb") || !srgb,
            "sRGB unimplemented"
        );
    ...
    ///
    /// Preferably call this before [`RenderLayer::render`][`super::renderer::RenderLayer::render`]
    ...
    pub fn set_viewport(&mut self, renderer: &Renderer, viewport: UVec2) {
        if viewport != self.dimensions {
            ...
            let resize_renderbuffer = |r: &WebGlRenderbuffer, format: u32, ms: bool| {
                ...
                if ms && renderer.antialiasing.is_msaa() {
                ...
                ColorBuffer::Renderbuffer(r) => {
                    ...
                    match self.depth_stencil {
                        ...
                        _ => {
                            ...
                            resize_renderbuffer(r, format, cfg!(feature = "renderer_webgl2"))
                        }
                    }
                }
            }
    ...
    /// [`draw`][`super::buffer::TriangleBufferBinding::draw`]s to draw to it.
    ///
...
impl<'a> FramebufferBinding<'a> {
    ...
    pub fn clear(&self) {
        ...
        let color = if self._framebuffer.srgb {
            super::rgba_array(self._framebuffer.background_color)
        } else {
            color
        };
