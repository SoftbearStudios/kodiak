...
use super::sprite_sheet::AudioSpriteSheet;
...
pub fn include_audio(item: TokenStream) -> TokenStream {
    ...
    quote! {
        ...
        impl kodiak_client::Audio for Audio {
            fn index(self) -> usize {
                self as usize
            }
            ...
            fn sprites() -> &'static [kodiak_client::AudioSprite] {
                static SPRITES: &'static [kodiak_client::AudioSprite] = &[
                    #(#sprites,)*
                ];
                SPRITES
            }
